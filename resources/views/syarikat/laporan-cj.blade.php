...
>
    <div class="space-y-6">
        <div class="rounded-2xl border border-slate-200 bg-white/95 p-6 shadow-lg shadow-slate-950/10">
            ...
            <form action="{{ route('syarikat.senarailaporan') }}" method="GET" class="space-y-6">
                <!-- Penanda pengesahan hantar borang -->
                ...
                <div class="mt-6">
                    ...
                    <div class="rounded-lg border border-dashed border-slate-300 bg-slate-50 p-4">
                        <input type="file" class="block w-full text-sm text-slate-600 focus:outline-none" />
