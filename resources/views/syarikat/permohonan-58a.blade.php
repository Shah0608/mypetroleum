    ...
    <div class="space-y-6">
        <div class="rounded-2xl border border-slate-200 bg-white/95 p-6 shadow-lg shadow-slate-950/10">
            ...
            <form action="{{ route('syarikat.permohonan-58a.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                @if ($errors->any())
                    <div class="rounded-xl border border-amber-300 bg-amber-100 px-4 py-3 text-sm font-semibold text-amber-900">
                ...
                <section class="space-y-4">
                    ...
                    <div class="grid gap-6 md:grid-cols-2">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="nama" value="{{ old('nama') }}" class="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 focus:border-blue-500 focus:outline-none" />
                        </div>
                        <div class="space-y-2">
                            <label class="text-sm font-medium text-slate-700">No. Telefon</label>
                            <input type="text" name="no_telefon" value="{{ old('no_telefon') }}" class="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 focus:border-blue-500 focus:outline-none" />
                        </div>
                        <div class="space-y-2">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="jawatan" value="{{ old('jawatan') }}" class="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 focus:border-blue-500 focus:outline-none" />
                        </div>
                        <div class="space-y-2">
                            <label class="text-sm font-medium text-slate-700">Nama Syarikat</label>
                            <input type="text" name="nama_syarikat" value="{{ old('nama_syarikat') }}" class="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 focus:border-blue-500 focus:outline-none" />
                        </div>
                        <div class="space-y-2">
                            <label class="text-sm font-medium text-slate-700">No. Pendaftaran Cukai Jualan (jika ada)</label>
                            <input type="text" name="no_pendaftaran_cukai" value="{{ old('no_pendaftaran_cukai') }}" class="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 focus:border-blue-500 focus:outline-none" />
                            <p class="text-xs text-slate-500">Medan ini pilihan dan hanya perlu diisi jika syarikat mempunyai nombor pendaftaran cukai jualan.</p>
                        </div>
                        <div class="space-y-2">
                            <label class="text-sm font-medium text-slate-700">Tarikh permohonan (dd/mm/yyyy)</label>
                            <input type="date" name="tarikh_permohonan" lang="ms-MY" value="{{ old('tarikh_permohonan') }}" class="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 focus:border-blue-500 focus:outline-none" />
                        </div>
                        <div class="space-y-2">
                            <label class="text-sm font-medium text-slate-700">No. Kelulusan (PDA2, JKDM dll)</label>
                            <input type="text" name="no_kelulusan" value="{{ old('no_kelulusan') }}" class="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 focus:border-blue-500 focus:outline-none" />
                        </div>
                        <div class="space-y-2">
                            <label class="text-sm font-medium text-slate-700">No. Pesanan Belian</label>
                            <input type="text" name="no_pesanan_belian" value="{{ old('no_pesanan_belian') }}" class="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 focus:border-blue-500 focus:outline-none" />
                        </div>
                        <div class="md:col-span-2 space-y-2">
                            <label class="text-sm font-medium text-slate-700">Alamat</label>
                            <textarea name="alamat" rows="3" class="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 focus:border-blue-500 focus:outline-none">{{ old('alamat') }}</textarea>
                        </div>
                        <div class="md:col-span-2 space-y-2">
                            ...
                            <select name="negeri" class="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 focus:border-blue-500 focus:outline-none">
                                ...
                                @foreach($states as $state)
                                    <option value="{{ $state }}" @selected(old('negeri') === $state)>{{ $state }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <section class="space-y-4">
                    ...
                    <div class="grid gap-6 md:grid-cols-2">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="tandatangan_nama" value="{{ old('tandatangan_nama') }}" class="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 focus:border-blue-500 focus:outline-none" />
                        </div>
                        <div class="space-y-2">
                            <label class="text-sm font-medium text-slate-700">No KP Pemohon</label>
                            <input type="text" name="tandatangan_no_kp" value="{{ old('tandatangan_no_kp') }}" class="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 focus:border-blue-500 focus:outline-none" />
                        </div>
                        <div class="md:col-span-2 space-y-2">
                            <label class="text-sm font-medium text-slate-700">Jawatan</label>
                            <input type="text" name="tandatangan_jawatan" value="{{ old('tandatangan_jawatan') }}" class="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 focus:border-blue-500 focus:outline-none" />
                        </div>
                    </div>
                </section>
                ...
                <section class="space-y-4">
                    ...
                    <div class="grid gap-6 md:grid-cols-2">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="pembekal_nama" value="{{ old('pembekal_nama') }}" class="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 focus:border-blue-500 focus:outline-none" />
                        </div>
                        <div class="md:col-span-2 space-y-2">
                            <label class="text-sm font-medium text-slate-700">Alamat</label>
                            <textarea name="pembekal_alamat" rows="3" class="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 focus:border-blue-500 focus:outline-none">{{ old('pembekal_alamat') }}</textarea>
                        </div>
                    </div>
                </section>
                    ...
                    <div class="overflow-x-auto rounded-2xl border border-slate-200 bg-slate-50 p-4">
                        <table class="min-w-full text-sm text-slate-700" id="barang-table">
                            ...
                            <tbody class="divide-y divide-slate-200 bg-white" id="barang-body">
                                @for ($i = 0; $i < $barangRows; $i++)
                                    <tr>
                                        <td class="px-3 py-2"><input name="kod_tarif[]" value="{{ old('kod_tarif.'.$i) }}" class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm text-slate-900 focus:border-blue-500 focus:outline-none" /></td>
                                        <td class="px-3 py-2"><input name="perihal_barang[]" value="{{ old('perihal_barang.'.$i) }}" class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm text-slate-900 focus:border-blue-500 focus:outline-none" /></td>
                                        <td class="px-3 py-2"><input name="unit[]" value="{{ old('unit.'.$i) }}" class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm text-slate-900 focus:border-blue-500 focus:outline-none" /></td>
                                        <td class="px-3 py-2"><input name="deskripsi[]" value="{{ old('deskripsi.'.$i) }}" class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm text-slate-900 focus:border-blue-500 focus:outline-none" /></td>
                                        <td class="px-3 py-2"><input name="kuantiti[]" type="number" step="any" value="{{ old('kuantiti.'.$i) }}" class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm text-slate-900 focus:border-blue-500 focus:outline-none" /></td>
                                        <td class="px-3 py-2"><input name="nilai[]" type="number" step="any" value="{{ old('nilai.'.$i) }}" class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm text-slate-900 focus:border-blue-500 focus:outline-none" /></td>
                                        <td class="px-3 py-2"><input name="kawasan[]" value="{{ old('kawasan.'.$i) }}" class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm text-slate-900 focus:border-blue-500 focus:outline-none" /></td>
